...
# ===============================
def run_svm_optimized(file_path, scenario_name):
    print("\n" + "=" * 60)
    print(f"🚀 RUNNING SVM SCENARIO: {scenario_name}")
    print("=" * 60)
...
# ===============================
results = []
results.append(run_svm_optimized('master.csv', 'Dynamic LULC (SVM)'))
results.append(run_svm_optimized('masterstatic.csv', 'Static LULC (SVM)'))
...
df_results.to_csv('svm_timeseries_optimized_results.csv', index=False)
